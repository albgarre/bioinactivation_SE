                              ...
                              tabPanel("Bigelow",
                                       sidebarLayout(
                                           sidebarPanel(
                                               ...
                                               sliderInput("bigelow_DR_start", "D_R", 0, 100, 10),
                                               checkboxInput("bigelow_DR_known", "known"),
                                               sliderInput("bigelow_z_start", "z", 0, 100, 10),
                                               checkboxInput("bigelow_z_known", "known"),
                                               sliderInput("bigelow_temRef_start", "temp_ref", 50, 200, 100),
                                               checkboxInput("bigelow_tempRef_known", "known"),
                                               sliderInput("bigelow_logN0_start", "log(N0)", 3, 8, 5),
                                               checkboxInput("bigelow_logN0_known", "known"),
                                               tags$hr(),
                                               tags$h4("Bounds for the adjustment"),
                                               sliderInput("bigelow_DR_range", "D_R", 0, 100, c(5, 20)),
                                               sliderInput("bigelow_z_range", "z", 0, 100, c(5, 20)),
                                               sliderInput("bigelow_tempRef_range", "temp_ref", 50, 200, c(70, 80)),
                                               sliderInput("bigelow_logN0_range", "log(N0)", 3, 8, c(4, 6)),
                                               tags$hr(),
                                               tags$h4("Quantiles for the prediction interval"),
                                               sliderInput("bigelow_quantiles", "", 0, 100, c(2.5, 97.5), step = 0.5),
